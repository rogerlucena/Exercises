...
// My old solution (not that space efficient) below (exceeds memory limit on InterviewBit).
// But good for intuition (one extra dimension for hasStock and another for nCompletedOperations - both with size 2).
// Top-down:
